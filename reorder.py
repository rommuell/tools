...
for i in xrange(i_0, i_0 + N, 1):
    ...
    bag = "/home/rm/Documents/master_thesis/blender/laborit_away/2/laborit2_away_bl.bag"
    directory_0 = "/home/rm/Documents/master_thesis/data/blender/laborit_away2/l_"
    directory = directory_0 + str(i)
    gt = "sim_blender" # set to leica (3D) resp. to vicon or sim or sim_blender (6D)

    #in case of sim_blender
    poses_gt = "/home/rm/Documents/master_thesis/data/blender/laborit_away2/poses.csv"
    ...
    egm_config = "/home/rm/Documents/master_thesis/data/blender/laborit_away2/l_10/egm.yaml"
